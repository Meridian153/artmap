...
export async function MuseumArtworkGallery({
  museumId,
}: MuseumArtworkGalleryProps) {
          ...
          {artworks.map((artwork) => (
            <li key={artwork.id}>
              ...
              >
                ...
                <div className="aspect-square w-full bg-zinc-100 flex items-center justify-center text-xs text-zinc-400">
                  이미지 준비 중
                </div>
                <div className="mt-3">
